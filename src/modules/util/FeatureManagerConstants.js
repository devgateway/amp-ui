...
const ACTIVITY_REGIONAL_FUNDING = 'Regional Funding';
...
const ACTIVITY_REGIONAL_FUNDINGS_PROVINCE = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/Region`;
const ACTIVITY_REGIONAL_FUNDINGS_COMMITMENTS_ADD_TRANSACTION = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_COMMITMENTS}/Add Transaction`;
const ACTIVITY_REGIONAL_FUNDINGS_COMMITMENTS_ADJUSTMENTS_TYPE = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_COMMITMENTS}/${ACTIVITY_REGIONAL_COMMITMENTS_TABLE}/Adjustment Type`;
const ACTIVITY_REGIONAL_FUNDINGS_COMMITMENTS_AMOUNT = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_COMMITMENTS}/${ACTIVITY_REGIONAL_COMMITMENTS_TABLE}/Amount`;
const ACTIVITY_REGIONAL_FUNDINGS_COMMITMENTS_CURRENCY = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_COMMITMENTS}/${ACTIVITY_REGIONAL_COMMITMENTS_TABLE}/Currency`;
const ACTIVITY_REGIONAL_FUNDINGS_COMMITMENTS_DELETE_ITEM = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_COMMITMENTS}/${ACTIVITY_REGIONAL_COMMITMENTS_TABLE}/Delete Item`;
const ACTIVITY_REGIONAL_FUNDINGS_COMMITMENTS_TRANSACTION_DATE = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_COMMITMENTS}/${ACTIVITY_REGIONAL_COMMITMENTS_TABLE}/Transaction Date`;
const ACTIVITY_REGIONAL_FUNDINGS_DISBURSEMENTS_ADD_TRANSACTION = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_COMMITMENTS}/Add Transaction`;
const ACTIVITY_REGIONAL_FUNDINGS_DISBURSEMENTS_ADJUSTMENTS_TYPE = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_DISBURSEMENTS}/${ACTIVITY_REGIONAL_DISBURSEMENTS_TABLE}/Adjustment Type`;
const ACTIVITY_REGIONAL_FUNDINGS_DISBURSEMENTS_AMOUNT = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_DISBURSEMENTS}/${ACTIVITY_REGIONAL_DISBURSEMENTS_TABLE}/Amount`;
const ACTIVITY_REGIONAL_FUNDINGS_DISBURSEMENTS_CURRENCY = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_DISBURSEMENTS}/${ACTIVITY_REGIONAL_DISBURSEMENTS_TABLE}/Currency`;
const ACTIVITY_REGIONAL_FUNDINGS_DISBURSEMENTS_DELETE_ITEM = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_DISBURSEMENTS}/${ACTIVITY_REGIONAL_DISBURSEMENTS_TABLE}/Delete Item`;
const ACTIVITY_REGIONAL_FUNDINGS_DISBURSEMENTS_TRANSACTION_DATE = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_DISBURSEMENTS}/${ACTIVITY_REGIONAL_DISBURSEMENTS_TABLE}/Transaction Date`;
const ACTIVITY_REGIONAL_FUNDINGS_EXPENDITURES_ADD_TRANSACTION = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_EXPENDITURES}/Add Transaction`;
const ACTIVITY_REGIONAL_FUNDINGS_EXPENDITURES_ADJUSTMENTS_TYPE = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_EXPENDITURES}/${ACTIVITY_REGIONAL_EXPENDITURES_TABLE}/Adjustment Type`;
const ACTIVITY_REGIONAL_FUNDINGS_EXPENDITURES_AMOUNT = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_EXPENDITURES}/${ACTIVITY_REGIONAL_EXPENDITURES_TABLE}/Amount`;
const ACTIVITY_REGIONAL_FUNDINGS_EXPENDITURES_CURRENCY = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_EXPENDITURES}/${ACTIVITY_REGIONAL_EXPENDITURES_TABLE}/Currency`;
const ACTIVITY_REGIONAL_FUNDINGS_EXPENDITURES_DELETE_ITEM = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_EXPENDITURES}/${ACTIVITY_REGIONAL_EXPENDITURES_TABLE}/Delete Item`;
const ACTIVITY_REGIONAL_FUNDINGS_EXPENDITURES_TRANSACTION_DATE = `/Activity Form/${ACTIVITY_REGIONAL_FUNDING}/${ACTIVITY_REGIONAL_ITEM}/${ACTIVITY_REGIONAL_EXPENDITURES}/${ACTIVITY_REGIONAL_EXPENDITURES_TABLE}/Transaction Date`;
