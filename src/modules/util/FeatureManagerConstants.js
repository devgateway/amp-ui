...
const ACTIVITY_LINE_MINISTRY_OBSERVATIONS_ADD_OBSERVATION = '/Activity Form/Line Ministry Observations/Add Observation';
const ACTIVITY_LINE_MINISTRY_OBSERVATIONS_DELETE_OBSERVATION = '/Activity Form/Line Ministry Observations/Observation/Delete Item';
const ACTIVITY_LINE_MINISTRY_OBSERVATIONS_ADD_MEASURE = '/Activity Form/Line Ministry Observations/Observation/Add Item';
const ACTIVITY_LINE_MINISTRY_OBSERVATIONS_DELETE_MEASURE = '/Activity Form/Line Ministry Observations/Observation/Measure/Delete Item';
const ACTIVITY_LINE_MINISTRY_OBSERVATIONS_ADD_ACTOR = '/Activity Form/Line Ministry Observations/Observation/Measure/Add Item';
const ACTIVITY_LINE_MINISTRY_OBSERVATIONS_DELETE_ACTOR = '/Activity Form/Line Ministry Observations/Observation/Measure/Actor/Delete Item';
...
const ME_ITEM_CURRENT_VALUE = `${ME_ITEM}/Current Value`;
const ME_ITEM_CURRENT_VALUE_BASE_COMMENTS = `${ME_ITEM_CURRENT_VALUE}/Current Comments`;
const ME_ITEM_CURRENT_VALUE_BASE_DATE = `${ME_ITEM_CURRENT_VALUE}/Current Date`;
const ME_ITEM_CURRENT_VALUE_BASE_VALUE = `${ME_ITEM_CURRENT_VALUE}/Current Value`;
...
export default Object.freeze({
  ...
  ACTIVITY_LINE_MINISTRY_OBSERVATIONS_ADD_OBSERVATION,
  ACTIVITY_LINE_MINISTRY_OBSERVATIONS_DELETE_OBSERVATION,
  ...
  ME_ITEM_CURRENT_VALUE,
  ME_ITEM_CURRENT_VALUE_BASE_COMMENTS,
  ME_ITEM_CURRENT_VALUE_BASE_DATE,
  ME_ITEM_CURRENT_VALUE_BASE_VALUE,
