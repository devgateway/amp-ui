...
const ACTIVITY_COMPONENTS = '/Activity Form/Components';
...
const ME_ITEM_LOCATION_ACTUAL_VALUES = `${ME_ITEM_LOCATION_ITEMS}/Actual Values`;
const ME_ITEM_LOCATION_ACTUAL_VALUES_ACTUAL_VALUE = `${ME_ITEM_LOCATION_ACTUAL_VALUES}/Actual Value`;
...
const REPORTING_ACTIVITY_PREVIEW = `${REPORTING}/Activity Preview`;
const REPORTING_ACTIVITY_PREVIEW_HIDE_TOTAL_ACTUAL_COMMITMENTS = `${REPORTING_ACTIVITY_PREVIEW}/Hide Total Actual Commitments`;
const REPORTING_ACTIVITY_PREVIEW_HIDE_TOTAL_ACTUAL_DISBURSEMENTS = `${REPORTING_ACTIVITY_PREVIEW}/Hide Total Actual Disbursements`;
const REPORTING_ACTIVITY_PREVIEW_HIDE_TOTAL_PLANNED_COMMITMENTS = `${REPORTING_ACTIVITY_PREVIEW}/Hide Total Planned Commitments`;
const REPORTING_ACTIVITY_PREVIEW_HIDE_TOTAL_PLANNED_DISBURSEMENTS = `${REPORTING_ACTIVITY_PREVIEW}/Hide Total Planned Disbursements`;
...
export default Object.freeze({
  ...
  ME_ITEM_LOCATION_ACTUAL_VALUES,
  ME_ITEM_LOCATION_ACTUAL_VALUES_ACTUAL_VALUE,
  ...
  ACTIVITY_COMPONENTS,
  REPORTING_ACTIVITY_PREVIEW_HIDE_TOTAL_ACTUAL_COMMITMENTS,
  REPORTING_ACTIVITY_PREVIEW_HIDE_TOTAL_ACTUAL_DISBURSEMENTS,
  REPORTING_ACTIVITY_PREVIEW_HIDE_TOTAL_PLANNED_COMMITMENTS,
  REPORTING_ACTIVITY_PREVIEW_HIDE_TOTAL_PLANNED_DISBURSEMENTS
});
